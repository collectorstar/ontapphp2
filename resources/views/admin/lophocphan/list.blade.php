...
<div class="search-container mt-3 mb-3">
    ...
    <a href="/admin/lophocphan/add" class="btn btn-success"><i class="fas fa-plus mr-1"></i>Thêm Lớp</a>
</div>
                ...
                for (let i = start; i <= end; i++) {
                    htmlResult += "\
                                <tr>\
                                    ...
                                    <td class ='MSSV'>" + listData[i - ci - 1].lqlten + "</td>\
                                    <td class='HoTen'>" + listData[i - ci - 1].lqlkhoahoc + "</td>\
                                    <td>\
